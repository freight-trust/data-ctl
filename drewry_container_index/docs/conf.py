#!/usr/bin/env python
#
# drewry_container_index documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'drewry_container_index.tex',
     'Container Freight Contract Index Documentation',
     'FreightTrust and Clearing Corporation', 'manual'),
]
...
man_pages = [
    (master_doc, 'drewry_container_index',
     'Container Freight Contract Index Documentation',
     [author], 1)
]
